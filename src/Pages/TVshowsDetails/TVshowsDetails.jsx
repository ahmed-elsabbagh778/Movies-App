    ...
    <>
      <div className="tvShows-details container-fluid px-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-8 info-container">
            ...
            <p>
              <strong>Release Date:</strong> {tvShows.first_air_date}
            </p>
            <p>
              <strong>Rating:</strong> {tvShows.vote_average}
            </p>
            <div className="details">
              <p>
                <strong>Duration:</strong>{" "}
                {tvShows.episode_run_time?.[0] || "N/A"} Min.
              </p>
              <p>
                <strong>Languages:</strong> {tvShows.original_language}
              </p>
      ...
      {recommendations.length > 0 && (
        <div className="container-fluid px-5 mt-5">
          <h3 className="recommendations-name text-white mb-4">
            Recommendations
          </h3>
